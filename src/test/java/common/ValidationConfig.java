...
public class ValidationConfig {
    ...
    public static List<UnaryOperator<Validation<ValidationFailure, ImmutableEgg>>> EGG_VALIDATION_CHAIN =
                    ...
                    .appendAll(Utils.liftAllToParentValidationType(CHILD_VALIDATION_CHAIN, ImmutableEgg::getYolk))
                    .appendAll(List.of(validateParent41, validateParent42, Utils.liftToParentValidationType(validateChild4, ImmutableEgg::getYolk)));
